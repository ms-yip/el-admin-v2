<template>
  ...
  >
    <el-form
      ...
      label-width="150px"
    >
      <el-form-item :label="$t('sys.data.code')" prop="code">
        <el-input v-model="dataForm.code" :maxlength="25"></el-input>
      </el-form-item>
      <el-form-item :label="$t('sys.data.nameEnUs')" prop="nameEnUs">
        <el-input v-model="dataForm.nameEnUs" :maxlength="25"></el-input>
      </el-form-item>
      <el-form-item :label="$t('sys.data.nameLocal')" prop="nameLocal">
        <el-input v-model="dataForm.nameLocal" :maxlength="25"></el-input>
      </el-form-item>
      <el-form-item :label="$t('sys.data.value')" prop="value">
        <el-input v-model="dataForm.value" :maxlength="25"></el-input>
      </el-form-item>
      <el-form-item :label="$t('sys.data.memo')" prop="memo">
        <el-input v-model="dataForm.memo" :maxlength="25"></el-input>
      </el-form-item>
      <el-form-item :label="$t('sys.data.flag')" prop="flag">
